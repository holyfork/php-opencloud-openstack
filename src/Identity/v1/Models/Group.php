...
class Group extends OperatorResource implements Creatable, Listable, Retrievable, Updateable, Deletable
{
    ...
    /**
     * @param array $data {@see \OpenStack\Identity\v1\Api::postGroups}
     */
    ...
    /**
     * @param array $options {@see \OpenStack\Identity\v1\Api::getGroupUsers}
     *
    ...
    /**
     * @param array $options {@see \OpenStack\Identity\v1\Api::putGroupUser}
     */
    ...
    /**
     * @param array $options {@see \OpenStack\Identity\v1\Api::deleteGroupUser}
     */
    ...
    /**
     * @param array $options {@see \OpenStack\Identity\v1\Api::headGroupUser}
     */
